...
if (import.meta.main) {
  ...
  // await aocapi.submitPart1({ year: "2023", day: "19" }, part1Solution);
  // await aocapi.submitPart2({ year: "2023", day: "19" }, part2Solution);
}

function part1() {
  const input = aocutil.readFile("./2023/19/input");
}
