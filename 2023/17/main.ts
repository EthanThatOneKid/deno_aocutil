...
import * as clumsy_crucible from "./clumsy_crucible.ts";
...
function part1() {
  const input = aocutil.readFile("./2023/17/sample_input");
  return clumsy_crucible.calculateMinHeatLossFromInput(input);
}
